...
|  Linux  |  Windows  |
|   ---   |    ---    |
|[![Build Status](https://travis-ci.org/NOhs/git_info.svg?branch=master)](https://travis-ci.org/NOhs/git_info) | [![Build status](https://ci.appveyor.com/api/projects/status/4yjtsb5phfve1gw9/branch/master?svg=true)](https://ci.appveyor.com/project/NOhs/git-info/branch/master) |
